...

{
	...
	ALLEGRO_BITMAP *airPic = al_load_bitmap("air.png");
	...
	ALLEGRO_BITMAP *NaoTomoriPic = al_load_bitmap("NaoTomori.jpg");
	...
	NaoTomori.initElement(400, 300, 5, NaoTomoriPic);
